...
class TestRoute53(TestCase):
    ...
    def test_user_given_credential(self, mock_client):
        ...
        mock_client.assert_called_once_with('route53', aws_access_key_id='mock-key', aws_secret_access_key='mock-secret')
    ...
    def test_route53_create_record(self, mock_client):
        ...
        mock_client.return_value.get_paginator.return_value.paginate.return_value = self.mocked_find_zone_response()
        mock_client.return_value.change_resource_record_sets.return_value = self.mocked_route53_set_record_response()
