...
class DuckDNSDns(common.BaseDns):
    ...
    def __init__(self, ACME_DNS_API_KEY, ACME_DNS_API_BASE_URL='https://www.duckdns.org', ACME_DNS_API_USER=''):
    ...
    def create_dns_record(self, domain_name, domain_dns_value):
        ...
        self.logger.info("domain_name: {0} ".format(domain_name))
        self.logger.info("domain_dns_value: {0} ".format(domain_dns_value))
        self.logger.info("ACME_DNS_API_BASE_URL: {0} ".format(self.ACME_DNS_API_BASE_URL))
        self.logger.info("ACME_DNS_API_USER: {0} ".format(self.ACME_DNS_API_USER))
        self.logger.info("ACME_DNS_API_KEY: {0} ".format(self.ACME_DNS_API_KEY))
